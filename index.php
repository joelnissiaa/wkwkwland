    ...
    <main class="main">
      ...
      <section id="hero" class="hero section">
        <div class="container d-flex flex-column justify-content-center align-items-center text-center position-relative" data-aos="zoom-out">
          ...
          <p>Sekolah dengan Pusat Keunggulan pada bidang keahlian <span><b>Pengembangan Perangkat Lunak dan Gim</b></span></p>
          <div class="d-flex">
            <a href="login.php" class="btn-get-started scrollto">Login</a>
            <a href="https://youtu.be/tKqXhUyuOm4?si=usGzcozN0NyGubcb" class="glightbox btn-watch-video d-flex align-items-center"><i class="bi bi-play-circle"></i><span>Watch Video</span></a>
          </div>
        </div>
      </section>
      <!-- /Hero Section -->
        ...
        <div class="container">
          ...
          <div class="col-xl-3 col-md-6 d-flex" data-aos="fade-up" data-aos-delay="200">
              <div class="service-item position-relative">
                ...
                <p>Jurusan <b>Rekayasa Perangkat Lunak</b> adalah bidang ilmu yang mempelajari cara membuat, memelihara, dan mengelola perangkat lunak. RPL juga mempelajari prinsip dan teknik mendesain perangkat lunak yang mudah digunakan dan tepat guna</p>
              </div>
            </div>
            <!-- End Service Item -->
            ...
            <div class="col-xl-3 col-md-6 d-flex" data-aos="fade-up" data-aos-delay="200">
              <div class="service-item position-relative">
                <div class="icon"><img src="assets/img/icon/car-engine.png" alt="Ruota di nave" width="50" height="50"></div>
                <h4><a href="" class="stretched-link">TKR</a></h4>
                <p>Jurusan <b>Teknik Kendaraan Ringan</b> adalah bidang studi yang mempelajari tentang perawatan, perbaikan, dan pemahaman mengenai kendaraan bermotor ringan. Jurusan ini mempelajari berbagai sistem kendaraan, seperti mesin, transmisi, sistem kelistrikan, dan lainnya</p>
              </div>
            </div>
            <!-- End Service Item -->
            ...
            <div class="col-xl-3 col-md-6 d-flex" data-aos="fade-up" data-aos-delay="300">
              <div class="service-item position-relative">
                <div class="icon"><img src="assets/img/icon/motorbike.png" alt="Ruota di nave" width="50" height="50"></div>
                <h4><a href="" class="stretched-link">TSM</a></h4>
                <p>Jurusan <b>Teknik Sepeda Motor</b> adalah kompetensi keahlian yang mempelajari tentang perakitan, perawatan, dan perbaikan sepeda motor. TSM merupakan salah satu konsentrasi keahlian dalam program keahlian Teknik Otomotif</p>
              </div>
            </div>
            <!-- End Service Item -->
            ...
            <div class="col-xl-3 col-md-6 d-flex" data-aos="fade-up" data-aos-delay="400">
              <div class="service-item position-relative">
                <div class="icon"><img src="assets/img/icon/ship-wheel.png" alt="Ruota di nave" width="50" height="50"></div>
                <h4><a href="" class="stretched-link">NKN</a></h4>
                <p>Jurusan <b>Nautika Kapal Niaga</b> mempelajari ilmu dan keahlian terkait pengoperasian kapal niaga. Materi yang dipelajari meliputi navigasi, keselamatan kapal, dan bahari</p>
              </div>
            </div>
            <!-- End Service Item -->
            <div class="col-xl-3 col-md-6 d-flex" data-aos="fade-up" data-aos-delay="400">
              <div class="service-item position-relative">
                ...
                <p>Jurusan <b>Teknik Pengelasan</b> Mempelajari berbagai teknik penyambungan logam menggunakan panas dan tekanan. Teknik ini juga dikenal dengan istilah welding</p>
              </div>
            </div>
            <!-- End Service Item -->
            <div class="col-xl-3 col-md-6 d-flex" data-aos="fade-up" data-aos-delay="400">
              <div class="service-item position-relative">
                <div class="icon"><img src="assets/img/icon/body-ship.png" alt="Ruota di nave" width="50" height="50"></i></div>
                <h4><a href="" class="stretched-link">KKB</a></h4>
                <p>Jurusan <b>Konstruksi Kapal Baja</b> mempelajari tentang proses perancangan, pembuatan, dan perawatan kapal yang terbuat dari baja</p>
              </div>
            </div>
            <!-- End Service Item -->
            <div class="col-xl-3 col-md-6 d-flex" data-aos="fade-up" data-aos-delay="400">
              <div class="service-item position-relative">
                <div class="icon"><img src="assets/img/icon/ship-engine.png" alt="Ruota di nave" width="50" height="50"></div>
                <h4><a href="" class="stretched-link">TPK</a></h4>
                <p>Jurusan <b>Teknik Permesinan Kapal</b> mempelajari tentang perancangan, konstruksi, perawatan, dan perbaikan sistem permesinan kapal</p>
              </div>
            </div>
            <!-- End Service Item -->
            <div class="col-xl-3 col-md-6 d-flex" data-aos="fade-up" data-aos-delay="400">
              <div class="service-item position-relative">
                <div class="icon"><img src="assets/img/icon/logistics-management.png" alt="Ruota di nave" width="50" height="50"></div>
                <h4><a href="" class="stretched-link">MANLOG</a></h4>
                <p>Jurusan <b>Manajemen Logistik</b> mempelajari proses pengiriman barang, pergudangan, dan pengelolaan barang lainnya</p>
              </div>
            </div>
            <!-- End Service Item -->
          </div>
      ...
      <section id="about" class="about section">
        ...
        <div class="container" data-aos="fade-up">
          <div class="row g-4 g-lg-5" data-aos="fade-up" data-aos-delay="200">
            ...
            <div class="col-lg-7">
              <h3 class="pt-0 pt-lg-5">Sekolah dengan Pusat Keunggulan pada bidang keahlian <b>Pengembangan Perangkat Lunak dan Gim</b></h3>
              ...
              <div class="tab-content">
                <div class="tab-pane fade show active" id="about-tab1">
                  ...
                  <p>“Menghebatkan SMKN 10 Semarang melalui Tinggal Landas Pembangunan Sekolah secara Terukur Berbasis Literasi dan Digitalisasi.”</p>

                  <div class="d-flex align-items-center mt-4">
                    <!-- <i class="bi bi-check2"></i> -->
                    <h4>Misi :</h4>
                  </div>
                  <p>1. Meningkatkan Literasi Siswa dan Guru dengan menyediakan program dan lingkungan pembelajaran yang mendorong minat baca dan pengembangan ketrampilan literasi.</p>
                  <p>2. Menerapkan Pendekatan Digital dalam Pembelajaran dengan integrasi teknologi digital dan pelatihan guru secara reguler.</p>
                  <p>3. Mengembangkan Kurikulum Berbasis Literasi dan Digitalisasi.</p>
                  <p>4. Meningkatkan Kompetensi Guru dalam penggunaan metode pembelajaran inovatif dengan memberikan akses ke sumber daya pendidikan digital</p>
                  <p>5. Membangun Kemitraan dengan Iduka untuk memperkuat link and match dengan perkembangan industri.</p>
                  <p>6. Melakukan evaluasi berdasarkan data untuk menyusun rencana aksi perbaikan dan pengembangan sekolah</p>
      ...
      <section id="clients" class="clients section">
        <div class="container" data-aos="fade-up">
          <div class="row gy-4">  
            ...
            <div class="col-xl-2 col-md-3 col-6 client-logo">
              <img src="assets/img/nexa.png" class="img-fluid" alt="" />
            </div>
            <!-- End Client Item -->
            ...
            <div class="col-xl-2 col-md-3 col-6 client-logo">
              <img src="assets/img/logo-itho.png" class="img-fluid" alt="" />
            </div>
            <!-- End Client Item -->

            <div class="col-xl-2 col-md-3 col-6 client-logo">
              <img src="assets/img/logo-telkomsel.png" class="img-fluid" alt="" />
            </div>
            <!-- End Client Item -->
          </div>
        </div>
              ...
              <div class="row gy-4">
                <div class="col-lg-8 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="100">
                  ...
                  <ul>
                    ...
                    <li>
                      <i class="bi bi-check-circle-fill"></i> Ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate trideta storacalaperda mastiro dolore eu fugiat nulla pariatur.
                    </li>
                  </ul>
                  <p>
      ...
      <section id="contact" class="contact section">
        ...
        <div class="container section-title" data-aos="fade-up">
          <h2>Kontak </h2>
          <p>Hubungi kami dengan mengisi formulis dibawah atau bisa melalui nomor dan media sosial yang kami sertakan dibawah</p>
        </div>
        <!-- End Section Title -->

        <div class="mb-5">
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3088.8769672544213!2d110.39943937371162!3d-6.966418868207724!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e70f4c8081bffaf%3A0xbb522f8061199b3!2sSMK%20Negeri%2010%20Semarang!5e1!3m2!1sid!2sid!4v1737203366403!5m2!1sid!2sid" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </div>
        <!-- End Google Maps -->
        ...
        <div class="container" data-aos="fade">
          <div class="row gy-5 gx-lg-5">
            <div class="col-lg-4">
              <div class="info">
                <h3>Hubungi Kami</h3>
                <p>Kami senang mendengar dari Anda! Jika Anda memiliki pertanyaan, masukan, atau memerlukan informasi lebih lanjut, silakan gunakan salah satu cara di bawah ini untuk menghubungi kami:</p>
